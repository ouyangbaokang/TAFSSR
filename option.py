...
parser.add_argument('--model_name', type=str, default='DistgSSR_o_h', help="model name")
parser.add_argument("--use_pre_ckpt", type=bool, default=False, help="use pre model ckpt")
parser.add_argument("--path_pre_pth", type=str, default='./log/SR_5x5_4x/ALL/DistgSSR_o_h/checkpoints/DistgSSR_o_h_5x5_4x_epoch_33_model.pth', help="path for pre model ckpt")
...
parser.add_argument('--path_for_test', type=str, default='./data_for_inference/')
